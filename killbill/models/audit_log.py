...
class AuditLog(object):
    ...
    def __init__(self, change_type=None, change_date=None, object_type=None, object_id=None, changed_by=None, reason_code=None, comments=None, user_token=None):  # noqa: E501
