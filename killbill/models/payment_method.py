...
class PaymentMethod(object):
    ...
    def __init__(self, payment_method_id=None, external_key=None, account_id=None, is_default=False, plugin_name=None, plugin_info=None, audit_logs=None):  # noqa: E501
