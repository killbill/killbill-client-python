...
class InvoiceItemApi(object):
    ...
    def create_invoice_item_tags(self, invoice_item_id=None, body=None, created_by=None, api_key=None, api_secret=None, **kwargs):  # noqa: E501
        """Add tags to invoice item  # noqa: E501

          # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.create_invoice_item_tags(invoice_item_id, body, created_by, api_key, api_secret, async=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async'):
            return self.create_invoice_item_tags_with_http_info(invoice_item_id, body, created_by, api_key, api_secret, **kwargs)  # noqa: E501
        else:
            (data) = self.create_invoice_item_tags_with_http_info(invoice_item_id, body, created_by, api_key, api_secret, **kwargs)  # noqa: E501
            return data

    def create_invoice_item_tags_with_http_info(self, invoice_item_id=None, body=None, created_by=None, api_key=None, api_secret=None, **kwargs):  # noqa: E501
        """Add tags to invoice item  # noqa: E501

          # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.create_invoice_item_tags_with_http_info(invoice_item_id, body, created_by, api_key, api_secret, async=True)
        >>> result = thread.get()
