...
class PluginInfoApi(object):
    ...
    def get_plugins_info(self, api_key=None, api_secret=None, **kwargs):  # noqa: E501
        ...
        >>> thread = api.get_plugins_info(api_key, api_secret, async=True)
        >>> result = thread.get()
        ...
        if kwargs.get('async'):
            return self.get_plugins_info_with_http_info(api_key, api_secret, **kwargs)  # noqa: E501
        else:
    ...
    def get_plugins_info_with_http_info(self, api_key=None, api_secret=None, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.get_plugins_info_with_http_info(api_key, api_secret, async=True)
        >>> result = thread.get()
        ...
        if ('api_key' not in params or
            ...
            raise ValueError("Missing the required parameter `api_key` when calling `get_plugins_info`")  # noqa: E501
        # verify the required parameter 'api_secret' is set
        if ('api_secret' not in params or
                params['api_secret'] is None):
            raise ValueError("Missing the required parameter `api_secret` when calling `get_plugins_info`")  # noqa: E501
