...
class InvoicePaymentApi(object):
    ...
    def get_invoice_payment_audit_logs_with_history(self, invoice_payment_id=None, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.get_invoice_payment_audit_logs_with_history(invoice_payment_id, async=True)
        >>> result = thread.get()
    ...
    def get_invoice_payment_audit_logs_with_history_with_http_info(self, invoice_payment_id=None, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.get_invoice_payment_audit_logs_with_history_with_http_info(invoice_payment_id, async=True)
        >>> result = thread.get()
