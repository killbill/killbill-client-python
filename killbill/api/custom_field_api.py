...
class CustomFieldApi(object):
    ...
    def get_custom_field_audit_logs_with_history(self, custom_field_id=None, api_key=None, api_secret=None, **kwargs):  # noqa: E501
        """Retrieve custom field audit logs with history by id  # noqa: E501

          # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.get_custom_field_audit_logs_with_history(custom_field_id, api_key, api_secret, async=True)
        >>> result = thread.get()
        ...
        if kwargs.get('async'):
            return self.get_custom_field_audit_logs_with_history_with_http_info(custom_field_id, api_key, api_secret, **kwargs)  # noqa: E501
        else:
            (data) = self.get_custom_field_audit_logs_with_history_with_http_info(custom_field_id, api_key, api_secret, **kwargs)  # noqa: E501
            return data

    def get_custom_field_audit_logs_with_history_with_http_info(self, custom_field_id=None, api_key=None, api_secret=None, **kwargs):  # noqa: E501
        """Retrieve custom field audit logs with history by id  # noqa: E501

          # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.get_custom_field_audit_logs_with_history_with_http_info(custom_field_id, api_key, api_secret, async=True)
        >>> result = thread.get()
        ...
        all_params = ['custom_field_id', 'api_key', 'api_secret']  # noqa: E501
        ...
        if ('api_key' not in params or
            ...
            raise ValueError("Missing the required parameter `api_key` when calling `get_custom_field_audit_logs_with_history`")  # noqa: E501
        # verify the required parameter 'api_secret' is set
        if ('api_secret' not in params or
                params['api_secret'] is None):
            raise ValueError("Missing the required parameter `api_secret` when calling `get_custom_field_audit_logs_with_history`")  # noqa: E501
