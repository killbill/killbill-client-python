...
class CreditApi(object):
    ...
    def create_credit(self, body=None, created_by=None, api_key=None, api_secret=None, **kwargs):  # noqa: E501
        ...
        >>> thread = api.create_credit(body, created_by, api_key, api_secret, async=True)
        >>> result = thread.get()
        ...
        if kwargs.get('async'):
            return self.create_credit_with_http_info(body, created_by, api_key, api_secret, **kwargs)  # noqa: E501
        else:
    ...
    def create_credit_with_http_info(self, body=None, created_by=None, api_key=None, api_secret=None, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.create_credit_with_http_info(body, created_by, api_key, api_secret, async=True)
        >>> result = thread.get()
        ...
        if ('created_by' not in params or
            ...
            raise ValueError("Missing the required parameter `created_by` when calling `create_credit`")  # noqa: E501
        # verify the required parameter 'api_key' is set
        if ('api_key' not in params or
                params['api_key'] is None):
            raise ValueError("Missing the required parameter `api_key` when calling `create_credit`")  # noqa: E501
        # verify the required parameter 'api_secret' is set
        if ('api_secret' not in params or
                params['api_secret'] is None):
            raise ValueError("Missing the required parameter `api_secret` when calling `create_credit`")  # noqa: E501
    ...
    def get_credit(self, credit_id=None, api_key=None, api_secret=None, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.get_credit(credit_id, api_key, api_secret, async=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async'):
            return self.get_credit_with_http_info(credit_id, api_key, api_secret, **kwargs)  # noqa: E501
        else:
    ...
    def get_credit_with_http_info(self, credit_id=None, api_key=None, api_secret=None, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.get_credit_with_http_info(credit_id, api_key, api_secret, async=True)
        >>> result = thread.get()
        ...
        all_params = ['credit_id', 'api_key', 'api_secret']  # noqa: E501
        all_params.append('async')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if ('api_key' not in params or
                params['api_key'] is None):
            raise ValueError("Missing the required parameter `api_key` when calling `get_credit`")  # noqa: E501
        # verify the required parameter 'api_secret' is set
        if ('api_secret' not in params or
                params['api_secret'] is None):
            raise ValueError("Missing the required parameter `api_secret` when calling `get_credit`")  # noqa: E501
