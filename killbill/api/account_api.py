...
class AccountApi(object):
    ...
    def create_account_tags(self, account_id=None, body=None, created_by=None, api_key=None, api_secret=None, **kwargs):  # noqa: E501
        """Add tags to account  # noqa: E501

          # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.create_account_tags(account_id, body, created_by, api_key, api_secret, async=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async'):
            return self.create_account_tags_with_http_info(account_id, body, created_by, api_key, api_secret, **kwargs)  # noqa: E501
        else:
            (data) = self.create_account_tags_with_http_info(account_id, body, created_by, api_key, api_secret, **kwargs)  # noqa: E501
            return data

    def create_account_tags_with_http_info(self, account_id=None, body=None, created_by=None, api_key=None, api_secret=None, **kwargs):  # noqa: E501
        """Add tags to account  # noqa: E501

          # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.create_account_tags_with_http_info(account_id, body, created_by, api_key, api_secret, async=True)
        >>> result = thread.get()
    ...
    def get_account_audit_logs(self, account_id=None, api_key=None, api_secret=None, **kwargs):  # noqa: E501
        """Retrieve audit logs by account id  # noqa: E501

          # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.get_account_audit_logs(account_id, api_key, api_secret, async=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async'):
            return self.get_account_audit_logs_with_http_info(account_id, api_key, api_secret, **kwargs)  # noqa: E501
        else:
            (data) = self.get_account_audit_logs_with_http_info(account_id, api_key, api_secret, **kwargs)  # noqa: E501
            return data

    def get_account_audit_logs_with_http_info(self, account_id=None, api_key=None, api_secret=None, **kwargs):  # noqa: E501
        """Retrieve audit logs by account id  # noqa: E501

          # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.get_account_audit_logs_with_http_info(account_id, api_key, api_secret, async=True)
        >>> result = thread.get()
        ...
        if ('api_key' not in params or
                params['api_key'] is None):
            raise ValueError("Missing the required parameter `api_key` when calling `get_account_audit_logs`")  # noqa: E501
        # verify the required parameter 'api_secret' is set
        if ('api_secret' not in params or
                params['api_secret'] is None):
            raise ValueError("Missing the required parameter `api_secret` when calling `get_account_audit_logs`")  # noqa: E501
